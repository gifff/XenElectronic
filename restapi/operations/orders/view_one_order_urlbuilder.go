...
func (o *ViewOneOrderURL) Build() (*url.URL, error) {
	...
	if orderID != "" {
		...
		return nil, errors.New("orderId is required on ViewOneOrderURL")
	}
...
func (o *ViewOneOrderURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on ViewOneOrderURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on ViewOneOrderURL")
	}
