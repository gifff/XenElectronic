...
// NewViewOneOrderParams creates a new ViewOneOrderParams object
// no default values defined in spec.
func NewViewOneOrderParams() ViewOneOrderParams {

	return ViewOneOrderParams{}
}

// ViewOneOrderParams contains all the bound params for the view one order operation
...
func (o *ViewOneOrderParams) bindOrderID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *ViewOneOrderParams) validateOrderID(formats strfmt.Registry) error {
