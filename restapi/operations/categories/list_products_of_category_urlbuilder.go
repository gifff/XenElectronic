...
func (o *ListProductsOfCategoryURL) WithBasePath(bp string) *ListProductsOfCategoryURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *ListProductsOfCategoryURL) Build() (*url.URL, error) {
	...
	var _path = "/categories/{category_id}/products"

	categoryID := swag.FormatInt64(o.CategoryID)
	if categoryID != "" {
		_path = strings.Replace(_path, "{category_id}", categoryID, -1)
	} else {
		return nil, errors.New("categoryId is required on ListProductsOfCategoryURL")
	}
...
func (o *ListProductsOfCategoryURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on ListProductsOfCategoryURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on ListProductsOfCategoryURL")
	}
