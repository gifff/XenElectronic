...
func (o *AddOneProductIntoCartURL) WithBasePath(bp string) *AddOneProductIntoCartURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *AddOneProductIntoCartURL) Build() (*url.URL, error) {
	...
	if cartID != "" {
		...
		return nil, errors.New("cartId is required on AddOneProductIntoCartURL")
	}
...
func (o *AddOneProductIntoCartURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on AddOneProductIntoCartURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on AddOneProductIntoCartURL")
	}
